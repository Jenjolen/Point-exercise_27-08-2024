...
public class PointDAOV2 {

    private static PointDAOV2 instance;

    private static EntityManagerFactory emf;

    public static PointDAOV2 getInstance(EntityManagerFactory _emf) {
        if (instance == null) {
            emf = _emf;
            instance = new PointDAOV2();
        }
        return instance;
...
//        em.close();
    ...
    public long findNumberOfObjects () {
